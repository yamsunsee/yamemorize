...
const Background = () => {
  ...
  return (
    <div>
      <Link to="/yamemorize">
        <div className="absolute top-2 left-2 flex cursor-pointer items-center justify-center text-2xl text-blue-200 transition-all hover:text-blue-50">
          <ion-icon name="arrow-back-circle"></ion-icon>
          <div className="ml-2 text-sm font-bold uppercase">
            {language === "english" ? "Back to home" : "Trở về trang chủ"}
          </div>
        </div>
      </Link>
      <div className="absolute right-2 top-2 text-sm font-bold text-blue-300/50">
